...
public class LatestNewsAdapter extends RecyclerView.Adapter<LatestNewsAdapter.ViewHolder> {
    ...
    public LatestNewsAdapter(ArrayList<News> newsArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.latest_news_list_item,parent,false);
...
//        holder.newsImg.setImageResource(news.getImage());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            newAuthorTV=itemView.findViewById(R.id.newsAuthorTV);
            newsDateTV=itemView.findViewById(R.id.newsDateTV);
            newsImg=itemView.findViewById(R.id.newsImageIV);
