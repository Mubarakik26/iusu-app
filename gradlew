...
<module external.linked.project.id=":app" external.linked.project.path="$MODULE_DIR$/../../../app" external.root.project.path="$MODULE_DIR$/../../.." external.system.id="GRADLE" external.system.module.group="IUSUAppv3_10_05_2022" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
